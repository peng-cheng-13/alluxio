            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.persistFiles = new ArrayList<PersistFile>(_list118.size);
                PersistFile _elem119;
                for (int _i120 = 0; _i120 < _list118.size; ++_i120)
                {
                  _elem119 = new PersistFile();
                  _elem119.read(iprot);
                  struct.persistFiles.add(_elem119);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PersistCommandOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.persistFiles != null) {
        oprot.writeFieldBegin(PERSIST_FILES_FIELD_DESC);
        {
          ...
          for (PersistFile _iter121 : struct.persistFiles)
          {
      ...
      if (struct.isSetPersistFiles()) {
        {
          ...
          for (PersistFile _iter122 : struct.persistFiles)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.persistFiles = new ArrayList<PersistFile>(_list123.size);
          PersistFile _elem124;
          for (int _i125 = 0; _i125 < _list123.size; ++_i125)
          {
            _elem124 = new PersistFile();
            _elem124.read(iprot);
            struct.persistFiles.add(_elem124);
          }
        }
        struct.setPersistFilesIsSet(true);
      }
